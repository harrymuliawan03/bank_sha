...
abstract class $TransactionStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<String> transactions});
}
...
class _$TransactionStateImpl implements _TransactionState {
  const _$TransactionStateImpl({final List<String> transactions = const []})
...
abstract class _TransactionState implements TransactionState {
  const factory _TransactionState({final List<String> transactions}) =
